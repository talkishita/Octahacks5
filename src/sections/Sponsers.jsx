...
const Sponsers = () => {
  return (
    ...
    <div id="sponsors" className='h-screen block md:flex justify-center flex-wrap bg-black'>

{/* left div----------------------------------------------------------------------------------------- */}
      <div className='bg-black h-screen w-screen flex text-center items-center justify-center'>
      ...
      <div className='h-full w-full justify-center text-center items-center bg-black'>
          ...
          <div className='flex flex-col text-center h-full items-center justify-center md:gap-4'>
