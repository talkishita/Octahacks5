...
const Judges = () => {
  return (
    <div id='judges' className='min-h-screen bg-slate-900 bg-no-repeat bg-contain p-2'>
      <div className='text-5xl lg:text-6xl xl:text-7xl text-center'>Judges</div>
         <div class="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 px-12 py-12 auto-rows-fr">
                ...
                <div data-aos="flip-up" data-aos-easing="ease-in-sine" class="w-full bg-white rounded-lg shadow-lg overflow-hidden flex flex-col justify-center items-center">
                    <div>
                ...
                <div data-aos="flip-right" data-aos-easing="ease-in-sine" class="w-full bg-white rounded-lg shadow-lg overflow-hidden flex flex-col justify-center items-center">
                    <div>
                ...
                <div data-aos="flip-down" data-aos-easing="ease-in-sine" class="w-full bg-white rounded-lg shadow-lg overflow-hidden flex flex-col justify-center items-center">
                    <div>
                        <img class="object-center object-cover h-auto w-full" src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1170&q=80" alt="photo" />
                    </div>
                    <div class="text-center py-8 sm:py-6">
