            ...
            <div className='safe'>
                ...
                <div >
                    ...
                    {/* <p className='textpara'></p> */}
                        <br/>
                <p className='textpara'>As the name suggests, Octahacks comprises 8 themes or impact areas to help spark your ideas. Remember that you're welcome to build the prototype with the technologies of
